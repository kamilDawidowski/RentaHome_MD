...
class Repository {
    ...
    suspend fun updateUser(username: String, name: String, surname: String, description: String): Response<User> {
        return  RetrofitInstance.api.updateUser(username, name, surname, description)
    }
