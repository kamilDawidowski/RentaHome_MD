 ...
 * Use the [ReservationClickFragment.newInstance] factory method to
...
class ReservationClickFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ReservationClickFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ReservationClickFragment().apply {
